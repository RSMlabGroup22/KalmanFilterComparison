function plotResultsEKF_strong_tracking(ds, ekf,outputDir)
    ...
    geoplot(ekf.lat, ekf.lon, 'g.-', 'LineWidth', 2.5, 'MarkerSize', 10, 'DisplayName', 'EKF Strong Tracking');

    
    geobasemap('streets'); 
    title('Extended Kalman Filter Strong Tracking');
